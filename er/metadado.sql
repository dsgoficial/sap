...
CREATE TABLE metadado.informacoes_produto(
	...
	limitacao_acesso_id INTEGER NOT NULL REFERENCES metadado.codigo_restricao (code),
	restricao_uso_id INTEGER NOT NULL REFERENCES metadado.codigo_restricao (code),
	grau_sigilo_id INTEGER NOT NULL REFERENCES metadado.codigo_classificacao (code),
	...
	datum_vertical_id INTEGER NOT NULL REFERENCES metadado.datum_vertical (code),
	especificacao_id INTEGER NOT NULL REFERENCES metadado.especificacao (code),

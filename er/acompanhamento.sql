...
$$
  ...
  BEGIN
    ...
    IF num > 0 THEN
      ...
      SELECT ut.id, ut.subfase_id, ut.disponivel, l.nome AS bloco, ut.nome, ut.dificuldade, dp.configuracao_producao AS dado_producao, dp.configuracao_producao, tdp.nome AS tipo_dado_producao, ut.prioridade, ut.geom';

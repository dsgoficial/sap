// Path: features\subphases\hooks\useSubphases.ts
import { useState, useEffect } from 'react';
import { useQuery } from '@tanstack/react-query';
import { getActivitySubphase, getSubphasesSituation, getUserActivities } from '@/services/subphaseService';
import { ChartGroup, TimelineGroup, SubphaseData } from '../types';

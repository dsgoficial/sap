...
router.get("/acao/usuario/:id", schemaValidation({ params: estatisticasSchema.idParams, query: estatisticasSchema.diasQuery }), asyncHandler(async (req, res, next) => {
...
router.get("/acao/em_execucao", asyncHandler(async (req, res, next) => {
